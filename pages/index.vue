  ...
  <div>
      ...
      <div class="container py-md-3">
        ...
        <div class="row about-grids agile-info">
          ...
          <div class="col-lg-3 col-md-4 w3-agile-grid mt-md-0 mt-4">
            ...
            <h3 class="grey">Financial Solutions</h3>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="services py-5">
      <div class="container agile-info py-md-3">
        <h3 class="heading mb-lg-5 mb-4">How we can help you</h3>
        <div class="row service_grids">
          <div class="col-lg-4 w3-agile-grid">
            <div class="grid">
              <h4 class="mb-3">Financial knowledge</h4>
              <p>
                Cras blandit nibh ut pretium elementum. Duis bibendum convallis nun ca dictum. Quisquen ac
                ipsum
            ...
            <div class="grid mt-4">
              <h4 class="mb-3">Loan acquisition</h4>
              <p>
                Cras blandit nibh ut pretium elementum. Duis bibendum convallis nun ca dictum. Quisquen ac
                ipsum
                porta, ultrices metus sit amet,
