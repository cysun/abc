      ...
      <div class="container py-md-3">
        ...
        <table class="table table-striped table-hover" ref="acts_come_here">
          <thead>
            ...
            <th scope="col" data-type="number">Reward</th>
            <th scope="col" data-role="annotation">Value</th>
            <th scope="col" data-role="annotation">Amount</th>
          ...
          <tr v-for="(act, index) in data.acts">
            ...
            <td>
              ...
              >{{act.enabled ? 'Disable':'Enable' }}</button>
            </td>
            <td>
