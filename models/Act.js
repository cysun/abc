...
actSchema.statics.initialize = async function (data) {
    ...
    if (data.profile_picture) {
        ...
        await this.getUniqueImageName()
            ...
            .then(async function () {
                await fs_read_file(data.picture).then(function (data) { buffer = data });
            })
            .then(async function () {
                await sharp(buffer).toFile(process.env.act_picture_folder + file_name + ".png")
            })
            ...
            .then(function () {
                ...
                act.image =
                    process.env.website + process.env.display_act_picture_folder + file_name + ".png";
            })
    }
